...
// of the type to be passed (numbers:int[])
// The available flags are opt, to make an argument optional, and link which will not be
// explained here.

VS_EXTERN_C __declspec(dllexport) void VS_CC VapourSynthPluginInit(VSConfigPlugin configFunc, VSRegisterFunction registerFunc, VSPlugin *plugin) {
